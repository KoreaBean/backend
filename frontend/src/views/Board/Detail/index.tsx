...
import {Board, CommnetListItem, FavoriteListItem} from "../../../types/interface";
...
export default function BoardDetail() {
          ...
          <div className='board-detail-top-header'>
            ...
            <div className='board-detail-top-sub-box'>
              <div className='board-detail-write-info-box'>
                ...
                <div className='board-detail-write-date'>{board.writeDataTime}</div>
              </div>
  ...
  const BoardDetailBottom = () => {
    ...
    const changeCommentHandler = (event : ChangeEvent<HTMLTextAreaElement>) => {
    ...
    const onCommentSubmitOnClickHandler = () => {
      if (!comment) return
      // todo : 백엔드 comment API 연동
    }



    ///           effect : 게시물 번호 path valiable이 바뀔 때 마다 좋아요 및 댓글 리스트 불러오기          //
    useEffect(() => {
              ...
              <div className='board-detail-bottom-comment-box'>
                ...
                <div className='board-detail-bottom-comment-input-box'>
                  <div className='board-detail-bottom-comment-input-container'>
                    <textarea ref={commentRef} className='board-detail-bottom-comment-textarea' placeholder={'댓글을 작성해 주세요.'}  value={comment} onChange={changeCommentHandler}/>
                    <div className='board-detail-bottom-comment-button-box'>
                      <div className={comment == '' ? 'disable-button' : 'black-button' } onClick={onCommentSubmitOnClickHandler}>{'댓글달기'}</div>
                    </div>
                  </div>
                </div>
              </div>
